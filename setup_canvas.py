...
dir_path = '/Volumes/WEB_DEV/hub-wrdigital/hub-app/app/(app)/clients/[id]/stories/new'

page_tsx_path = os.path.join(dir_path, 'page.tsx')
canvas_editor_path = os.path.join(dir_path, 'CanvasEditor.tsx')

page_tsx_code = """import dynamic from 'next/dynamic'
...
with open(canvas_editor_path, 'w') as f:
    f.write(canvas_editor_code)

print("Canvas Editor setup completed successfully.")
