...
function getApp(): admin.app.App {
  ...
  // La normalizzazione ripara i modi in cui una private key si rovina nel
  // copia-incolla (vedi lib/google-private-key.ts). Qui però il fallimento non
  // deve mai *peggiorare*: getDb() e getAuth() catturano le eccezioni e
  // restituirebbero null, trasformando una chiave illeggibile in un guasto
  // silenzioso — proprio la classe di problemi che stiamo eliminando. Se la
  // normalizzazione non riesce si prosegue col valore grezzo, che fallirà più
  // avanti esattamente come faceva prima.
